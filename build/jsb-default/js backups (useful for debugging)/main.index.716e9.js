...
t.prototype.requestBuyIAP = function() {
cc.log("Buy IAP");
jsb.reflection.callStaticMethod("org/cocos2dx/javascript/JavaBridge", "BuyIAP", "(Ljava/lang/String;)V", "com.herofi.game.removeads");
};
t.prototype.LogEvent = function() {};
...
cc.NativeEventHandler.eventOnPurchase_Android = function(e) {
console.log("eventOnPurchase_Android: " + e);
};
