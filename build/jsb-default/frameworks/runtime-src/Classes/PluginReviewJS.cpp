...
static bool js_PluginReviewJS_PluginReview_rateInAppstore(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        bool arg0;
        ok &= seval_to_boolean(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_PluginReviewJS_PluginReview_rateInAppstore : Error processing arguments");
...
SE_BIND_FUNC(js_PluginReviewJS_PluginReview_rateInAppstore)

static bool js_PluginReviewJS_PluginReview_setGDPR(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        bool arg0;
        ok &= seval_to_boolean(args[0], &arg0);
        SE_PRECONDITION2(ok, false, "js_PluginReviewJS_PluginReview_setGDPR : Error processing arguments");
...
SE_BIND_FUNC(js_PluginReviewJS_PluginReview_setGDPR)
...
bool js_register_PluginReviewJS_PluginReview(se::Object* obj)
{
    ...
    cls->defineStaticFunction("rateInAppstore", _SE(js_PluginReviewJS_PluginReview_rateInAppstore));
    cls->defineStaticFunction("setGDPR", _SE(js_PluginReviewJS_PluginReview_setGDPR));
